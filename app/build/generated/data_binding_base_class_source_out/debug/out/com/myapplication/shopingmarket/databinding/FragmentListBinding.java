...
public final class FragmentListBinding implements ViewBinding {
  ...
  private FragmentListBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView itemView) {
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.item_view;
      RecyclerView itemView = ViewBindings.findChildViewById(rootView, id);
      if (itemView == null) {
        break missingId;
      }

      return new FragmentListBinding((LinearLayout) rootView, itemView);
    }
