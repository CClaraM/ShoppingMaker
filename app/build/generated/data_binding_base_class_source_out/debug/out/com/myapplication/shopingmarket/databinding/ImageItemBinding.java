...
public final class ImageItemBinding implements ViewBinding {
  ...
  private ImageItemBinding(@NonNull RelativeLayout rootView, @NonNull ImageView ItemImageView) {
  ...
  public static ImageItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ImageItemBinding((RelativeLayout) rootView, ItemImageView);
    }
